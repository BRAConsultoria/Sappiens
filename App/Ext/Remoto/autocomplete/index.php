...
if (!isset($_SESSION['organogramaCod'])) {
    echo \json_encode(array(array('id' => '0', 'value' => 'erro', 'label' => 'Organograma não infnormado, faça o login novamente!')));
}
...
try {
    ...
    $sql = $qb->select($ccod . ' cod', $cdes . ' dsc')
            ...
            ->andWhere($qb->expr()->eq('organogramaCod', $_SESSION['organogramaCod']))
    ...
    echo \json_encode(array(array('id' => '0', 'value' => 'erro', 'label' => $e->getMessage())));
}
